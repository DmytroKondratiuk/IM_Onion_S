...
MIT (деталі — у `CITATION.cff` і майбутньому файлі `LICENSE`). Код оприлюднений
...
Dmytro Kondratiuk — дисертаційне дослідження зі спеціальності 051 «Економіка», тема «Стратегічне управління цифровою трансформацією агропродовольчих підприємств: теорія, методологія, імплементація».
